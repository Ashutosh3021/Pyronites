  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/auth/login`, {
        ...
        // Credentials: 'include' so the server can set an httpOnly session cookie
        credentials: 'include',
      ...
      if (res.ok) {
        ...
        // Use a generic message regardless of the status code — never reveal
  ...
  return (
    <AuthShell width="sm">
      <div className="p-8 space-y-6">
        ...
        {/* GitHub — placeholder, not yet wired */}
        <button
          type="button"
